  ...
  $(document).ready(function () {
    ...
    $("#doorclick").mouseup(function() {
      if($('.menu').is(':visible') === false){
        $('.arc').css({ 'background-color': 'indigo'});
      }
