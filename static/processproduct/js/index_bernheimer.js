  ...
  $(document).ready(function () {
    ...
    $("#doorclick").mouseup(function() {
      if($('.menu').is(':visible') === false){
        $('.arc').css({ 'background-color': 'DarkGreen'});
      }
...
$(document).ready(function () {
  ...
  if ( hash === 'one') {
    $('#one').css('background-color', 'DarkGreen');
    $('#one').css('color', 'white');
    $('#one').children().css('color', 'white');
  };

if ( hash === 'two') {
    $('#two').css('background-color', 'DarkGreen');
    $('#two').css('color', 'white');
    $('#two').children().css('color', 'white');
  };

  if ( hash === 'three') {
    $('#three').css('background-color', 'DarkGreen');
    $('#three').css('color', 'white');
    $('#three').children().css('color', 'white');
  };

  if ( hash === 'four') {
    $('#four').css('background-color', 'DarkGreen');
