...
$(document).ready(function () {
  ...
  if ( hash === 'one') {
    $('#one').css('background-color', 'teal');
    $('#one').css('color', 'white');
    $('#one').children().css('color', 'white');
  };

if ( hash === 'two') {
    $('#two').css('background-color', 'teal');
    $('#two').css('color', 'white');
  ...
  if ( hash === 'eight') {
    $('#eight').css('background-color', 'teal');
