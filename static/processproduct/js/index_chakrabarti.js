  ...
  $(document).ready(function () {
    ...
    $("#doorclick").mouseup(function() {
      if($('.menu').is(':visible') === false){
        $('.arc').css({ 'background-color': 'purple'});
      }
...
if ( hash === 'two') {
    $('#two').css('background-color', 'purple');
    $('#two').css('color', 'white');
    $('#two').children().css('color', 'white');
  };

  if ( hash === 'three') {
    $('#three').css('background-color', 'purple');
    $('#three').css('color', 'white');
    $('#three').children().css('color', 'white');
  };

  if ( hash === 'four') {
    $('#four').css('background-color', 'purple');
...
$( document ).ready(function() {
  ...
  $('.tagthirteen').mouseleave(function(){
      ...
      // $('#thirteen').children('.out').css('color', 'purple');
  });
