...
import * as __route_index_json from "../src/routes/index.json.js";
import * as __route_last$45modified_json from "../src/routes/last-modified.json.js";
import * as __route_contributors_json from "../src/routes/contributors/index.json.js";
import * as __route_contributors_$slug_json from "../src/routes/contributors/[slug].json.js";
import * as __route_support_json from "../src/routes/support.json.js";
import * as __route_search_json from "../src/routes/search.json.js";
import * as __route_about_json from "../src/routes/about.json.js";
import * as __route_articles_json from "../src/routes/articles/index.json.js";
import * as __route_articles_$slug_json from "../src/routes/articles/[slug].json.js";
import * as __route_folds_json from "../src/routes/folds/index.json.js";
import * as __route_folds_$slug_json from "../src/routes/folds/[slug].json.js";
...
import __archive from "../src/routes/archive/index.html";
...
export const manifest = {
	server_routes: [
		{
			// index.json.js
			pattern: /^\/index.json$/,
			handlers: __route_index_json,
			params: () => ({})
		},

		{
			// last-modified.json.js
			pattern: /^\/last-modified.json$/,
			handlers: __route_last$45modified_json,
			params: () => ({})
		},

		{
			// contributors/index.json.js
			pattern: /^\/contributors.json$/,
			handlers: __route_contributors_json,
			params: () => ({})
		},

		{
			// contributors/[slug].json.js
			pattern: /^\/contributors\/([^\/]+?).json$/,
			handlers: __route_contributors_$slug_json,
...

		{
			...
			handlers: __route_articles_json,
			params: () => ({})
		},

		{
			// articles/[slug].json.js
			pattern: /^\/articles\/([^\/]+?).json$/,
			handlers: __route_articles_$slug_json,
			params: match => ({ slug: d(match[1]) })
		},
...

		{
			// folds/[slug].json.js
			pattern: /^\/folds\/([^\/]+?).json$/,
			handlers: __route_folds_$slug_json,
			params: match => ({ slug: d(match[1]) })
		}
	],
	...
	pages: [
...

		{
			...
			parts: [
				null,
				{ name: "contributors", file: "contributors/index.html", component: __contributors }
			]
		},
...

		{
			...
			parts: [
				null,
				{ name: "articles", file: "articles/index.html", component: __articles }
			]
		},

		{
			...
			parts: [
				null,
				{ name: "articles_$slug", file: "articles/[slug].html", component: __articles_$slug, params: match => ({ slug: d(match[1]) }) }
			]
		},

		{
			...
			parts: [
				...
				{ name: "archive", file: "archive/index.html", component: __archive }
			]
		},

		{
			...
			parts: [
				{ name: "archive__layout", file: "archive/_layout.html", component: __archive__layout },
				{ name: "archive_contributors", file: "archive/contributors.html", component: __archive_contributors }
			]
		},

		{
			...
			parts: [
				{ name: "archive__layout", file: "archive/_layout.html", component: __archive__layout },
				{ name: "archive_articles", file: "archive/articles.html", component: __archive_articles }
			]
		},
...

		{
			...
			parts: [
				null,
				{ name: "folds", file: "folds/index.html", component: __folds }
			]
		},
...

		{
			...
			pattern: /^\/([^\/]+?)\/?$/,
			parts: [
				{ name: "$slug", file: "[slug].html", component: __$slug, params: match => ({ slug: d(match[1]) }) }
			]
		}
	],
